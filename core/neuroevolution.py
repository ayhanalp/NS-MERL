...
class SSNE :
    ...
    def __init__(self, args) :
        ...
        self.extinction_magnitude = args.extinction_magnitude  # Probabilty of extinction for each genome, given an extinction event
    ...
    def crossover_inplace(self, gene1, gene2) :
        ...
        for key in keys1:
            ...
            if len(W1.shape) == 2:  # Weight no bias
    ...
    def mutate_inplace(self, gene):
        ...
        for i, param in enumerate(gene.parameters()):  # Mutate each param
            ...
            elif len(W.shape) == 1:  # Bias or layer norm
    ...
    def get_anchors(self, states, pop, net_inds, lineage_rank):
        ...
        # Compute all actions
        if (self.args.ps != 'trunk' and self.args.ps != 'rtrunk') and (
    ...
    def evolve(self, pop, net_inds, fitness_evals, migration, states):
        ...
        lineage_scores = []  # Tracks the average lineage score for the generation
        ...
        if self.scheme == 'multipoint':
            ...
            for policy in migration:
                ...
                try:
                    ...
                    print("I am the error from NE, couldn't pop, because it's empty")
                    replacee = elites[0]  # Trying new, executed very rarely
